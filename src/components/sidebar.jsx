...
export default function Sidebar() {
    ...
    const activeButton = location.pathname === "/profile" ? "user" : "link";
        ...
        <div>
            <div className="p-[16px] flex items-center justify-between bg-[#FFFFFF] rounded-b-lg md:ml-[24px] md:mr-[24px] md:rounded-lg">
                <div
                    ...
                    className="items-center flex gap-x-1.5 p-[10px] cursor-pointer"
                >
                    <img src="/images/link-icon.svg" alt="" />
                    <p className="font-bold font-stretch-100% text-2xl md:flex hidden">
                        devlinks
                    </p>
                </div>
                <div className="flex">
                ...
                <div>
                    <img
                        ...
                        className="md:hidden"
                    />
                    <button className="hidden md:flex pt-[11px] pl-[27px] pb-[11px] pr-[27px] border rounded-lg border-[#6B46C1] text-[#6B46C1] hover:bg-[#EFEBFF] hover:text-[#633CFF] delay-30">
                        Preview
                    </button>
                </div>
            </div>
